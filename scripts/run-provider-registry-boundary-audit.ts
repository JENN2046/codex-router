...
const REQUIRED_REGISTRY_SOURCE_MARKERS = [
  ...
  "registerProvider(",
  "providerAttestationEntryFromRegistryProvider",
  "providerAttestationEntryFromManifest",
...
const REQUIRED_REGISTRY_TEST_MARKERS = [
  ...
  "provider-registry selection accepts providers registered through registerProvider",
