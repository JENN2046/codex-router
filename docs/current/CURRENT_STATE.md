...
- source tree digest: `git-ls-tree-sha256`
  `20fd24eb33222ac512d11aea5e36ed7a3c2b10666f68e451304481c9dd9f60e1`
...
- records regression coverage for no-op, non-main branch rejection, bounded
  commit/push, commit-only resume, contaminated resume blocking, stale remote
  push blocking, and after-push audit ordering.
...
Validation recorded for source commit `f4e6ff3`:
